...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    Bindings.InitBindings(m_operatorController, m_driverController, m_testVisionController, m_DriveSubsystem, m_ArmSubsystem, m_ElevatorSubsystem, m_IntakeSubsystem, m_LedSubsystem);
