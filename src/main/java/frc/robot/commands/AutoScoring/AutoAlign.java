...
public class AutoAlign extends Command {
    ...
    public AutoAlign(Setpoints setpoint, Supplier<Side> side, Supplier<Translation2d> offset, SwerveSubsystem swerveSubsystem, ArmSubsystem armSubsystem, ElevatorSubsystem elevatorSubsystem) {
        m_setpoint = setpoint;
        m_side = side.get();
        m_offset = offset.get();
